...
void nextGreaterELement(int arr[], int s);
void arrangeStartandLastPair(int arr[], int s);
void disElem(int arr[], int s);
void rotateElemRight(int arr[], int s);
void zeroToTheRight(int arr[], int s);
void frequencyCount (int arr[], int s);
void secondLargestElement(int arr[], int s);
